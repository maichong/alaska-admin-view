...
var Copyright = function (_React$Component) {
  ...
  function Copyright(props, context) {
    (0, _classCallCheck3.default)(this, Copyright);

    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Copyright).call(this, props));
  ...
  (0, _createClass3.default)(Copyright, [{
    ...
    value: function render() {
      ...
      var el = _react2.default.createElement(
        ...
        (0, _wrap2.default)(views.wrappers.copyrightText, _react2.default.createElement(
          'p',
          { style: styles.p },
          props.value
        ))
      );
      return (0, _wrap2.default)(views.wrappers.copyright, el);
    }
  }]);
  return Copyright;
...
Copyright.childContextTypes = {
  muiTheme: _react2.default.PropTypes.object,
  views: _react2.default.PropTypes.object
};
Copyright.mixins = [_contextPure2.default];
