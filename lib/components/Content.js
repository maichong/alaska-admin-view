...
var Content = function (_React$Component) {
  ...
  function Content(props, context) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Content).call(this, props));
  ...
  (0, _createClass3.default)(Content, [{
    ...
    value: function render() {
      ...
      return (0, _wrap2.default)(state.views.wrappers.content, _react2.default.createElement(
        'div',
        { id: 'content', style: styles.root },
        (0, _wrap2.default)(state.views.wrappers.contentInner, _react2.default.createElement(
          'div',
