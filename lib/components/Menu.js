...
var Menu = function (_React$Component) {
  ...
  (0, _createClass3.default)(Menu, [{
    ...
    key: '_createMenuItem',
    value: function _createMenuItem(item) {
      var _this2 = this;
      ...
      var nestedItems = _.map(item.subs, function (sub) {
        return _this2._createMenuItem(sub, level + 1);
      });
      ...
      var wrappers = _.get(views.wrappers, 'menu-' + item.id.replace(/\./g, '-'));
      if (wrappers) {
        el = (0, _wrap2.default)(wrappers, el);
      }
      el = (0, _wrap2.default)(views.wrappers.menuItem, el);
    ...
    value: function render() {
      ...
      return (0, _wrap2.default)(views.wrappers.menu, _react2.default.createElement(
        ...
        _.map(props.menu, function (item) {
          return _this3._createMenuItem(item);
        })
      ));
    }
  }]);
