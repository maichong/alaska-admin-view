...
var Locked = function (_React$Component) {
  ...
  function Locked() {
    ...
    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Locked).apply(this, arguments));
  }
  ...
  (0, _createClass3.default)(Locked, [{
    ...
    value: function render() {
      ...
      return (0, _wrap2.default)(this.context.views.wrappers.locked, _react2.default.createElement(
        'h1',
        { style: style },
        '无权访问'
      ), this);
