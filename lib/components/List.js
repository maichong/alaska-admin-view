...
var List = function (_React$Component) {
  ...
  (0, _createClass3.default)(List, [{
    ...
    value: function render() {
      ...
      return (0, _wrap2.default)(state.views.wrappers.list, _react2.default.createElement(
        'div',
        { style: styles.root },
        ...
        _react2.default.createElement(_DataTable2.default, { model: state.model, data: state.data })
      ));
    }
  }, {
    key: '_init',
