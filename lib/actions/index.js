...
exports.remove = exports.save = exports.search = exports.details = exports.list = exports.login = exports.logout = exports.refreshInfo = exports.notice = undefined;
...
var search = exports.search = (0, _actionCreator.createAsyncAction)(_constants.SEARCH, function () {
    ...
    return _regenerator2.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return _api2.default.post(_constants.PREFIX + '/api/search?' + (0, _qs.stringify)(args));
...
var remove = exports.remove = (0, _actionCreator.createAsyncAction)(_constants.REMOVE, function () {
  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5(args, dispatch) {
